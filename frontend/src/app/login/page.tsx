...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#F8FBFF] text-slate-900">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(135deg,#ffffff_0%,#f8fbff_40%,#eaf3ff_100%)]" />
      <div className="absolute -left-40 -top-40 h-[420px] w-[420px] rounded-full bg-blue-300/40 blur-3xl" />
      <div className="absolute -bottom-48 -right-48 h-[520px] w-[520px] rounded-full bg-sky-300/40 blur-3xl" />
      <div className="absolute left-1/2 top-20 h-72 w-72 -translate-x-1/2 rounded-full bg-indigo-200/30 blur-3xl" />

      {/* Grid Pattern */}
      <div className="absolute inset-0 opacity-[0.25] bg-[linear-gradient(to_right,#93c5fd_1px,transparent_1px),linear-gradient(to_bottom,#93c5fd_1px,transparent_1px)] bg-[size:44px_44px]" />

      <section className="relative z-10 flex min-h-screen items-center justify-center px-6 py-10">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[2.5rem] border border-white/80 bg-white/70 shadow-[0_40px_120px_rgba(30,64,175,0.18)] backdrop-blur-2xl lg:grid-cols-[1.05fr_0.95fr]">
          {/* Left Panel */}
          <div className="relative hidden min-h-[720px] overflow-hidden bg-[#0B1F4D] p-12 text-white lg:flex lg:flex-col lg:justify-between">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_20%,rgba(59,130,246,0.85),transparent_34%),radial-gradient(circle_at_80%_70%,rgba(14,165,233,0.55),transparent_35%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(145deg,rgba(15,23,42,0.12),rgba(15,23,42,0.98))]" />

            {/* Decorative */}
            <div className="absolute -right-24 top-20 h-80 w-80 rounded-full border border-white/10" />
            <div className="absolute -right-40 top-4 h-[460px] w-[460px] rounded-full border border-white/10" />
            ...
            <div className="relative z-10 flex items-center justify-between">
              ...
              <span className="rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-medium text-blue-50 backdrop-blur">
                v1.0
              </span>
            </div>
            ...
            <div className="relative z-10 max-w-xl">
              <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-sm text-blue-50 backdrop-blur">
                ...
                Dashboard Pengadaan Barang/Jasa Kesehatan
              </div>

              <h2 className="text-5xl font-black leading-[1.08] tracking-[-0.04em]">
                Monitoring pengadaan dalam satu dashboard modern.
              </h2>

              <p className="mt-6 max-w-md text-base leading-7 text-blue-100">
                Pantau paket pengadaan, vendor, HPS digital, risiko, dokumen,
                dan progres pekerjaan dengan tampilan yang rapi dan terpusat.
              </p>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-3 gap-4">
              ...
              <div className="rounded-3xl border border-white/15 bg-white/10 p-5 shadow-2xl backdrop-blur-xl">
                ...
                <p className="mt-1 text-sm text-blue-100">Progress</p>
              </div>

              <div className="rounded-3xl border border-white/15 bg-white/10 p-5 shadow-2xl backdrop-blur-xl">
                <p className="text-3xl font-black">14</p>
                <p className="mt-1 text-sm text-blue-100">Review</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex min-h-[720px] items-center justify-center px-6 py-10 sm:px-12">
  ...
  <div className="mb-10 flex items-center gap-3 lg:hidden">
    ...
    <div>
      <h1 className="font-bold text-slate-950">Dinkes Jabar</h1>
  ...
  >
    ← Back ke Landing Page
  </button>

  <div className="mb-10">
    <p className="mb-4 text-xs font-bold uppercase tracking-[0.35em] text-blue-700">
      Secure Access
    </p>

    <h2 className="text-5xl font-black tracking-[-0.05em] text-slate-950">
      Welcome Back
    </h2>

    <p className="mt-4 max-w-sm text-sm leading-6 text-slate-500">
      Masuk untuk mengelola dashboard pengadaan barang/jasa kesehatan secara
      aman dan terstruktur.
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <div className="absolute left-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-xl bg-blue-50 text-blue-600 transition group-focus-within:bg-blue-600 group-focus-within:text-white">
                      @
                    </div>
              ...
              <div className="mt-10 flex items-center justify-center gap-2 text-xs text-slate-400">
                ...
                <p>
                  © 2026 Dashboard Pengadaan Barang/Jasa Kesehatan Provinsi
                  Jawa Barat
                </p>
              </div>
            </div>
